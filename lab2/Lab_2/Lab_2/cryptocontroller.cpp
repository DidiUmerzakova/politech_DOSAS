...
void cryptoController::encrypt_login_or_password(QString password) {
    ...
    QFile out("C:\\Users\\USER\\Desktop\\politech\\avtomat_explot\\lab2\\Lab_2\\Lab_2\\out.txt");
    ...
    QFile in("C:\\Users\\USER\\Desktop\\politech\\avtomat_explot\\lab2\\Lab_2\\Lab_2\\in.txt");
...
QString cryptoController::decrypt_login_or_password(QString text, QString password) {
    ...
    //переводим из формата Base64 полученную строку и хранит в себе нечитаемые символы
    ...
    //QFile file("C:\\Users\\USER\\Desktop\\politech\\avtomat_explot\\lab2\\Lab_2\\Lab_2\\out.txt");
...
bool cryptoController::check_password(QString password) {
    ...
    char buffer[256] = {0};//хранит в себе зашифрованный пароль
    QFile source_file("C:\\Users\\USER\\Desktop\\politech\\avtomat_explot\\lab2\\Lab_2\\Lab_2\\password_crypt.txt");
...
void cryptoController::decrypt_db_file(QString password, int record_id, int is_password)
{
        ...
        if(is_password == -1)
            emit sendDbToQml(db_decrypted);//передаем все в qml
}
...
void cryptoController::encrypt_db_file(QString password, int record_id, int is_password)
{
    ...
    EVP_CIPHER_CTX *ctx;
        ...
        QFile file("C:\\Users\\USER\\Desktop\\politech\\avtomat_explot\\lab2\\Lab_2\\Lab_2\\db_crypt.json");
        file.open(QIODevice::WriteOnly);
