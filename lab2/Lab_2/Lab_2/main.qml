...
ApplicationWindow {
    ...
    height: 480
    visible: true
    title: qsTr("Umerzakova_lab2")

    //переменные типа констант
    ...
    function crypt_controller(password) {
            let is_correct_passwd = cryptoController.check_password(password)//хранит информацию о пинкоде
...
//                    cryptoController.encrypt_db_file(password)
                    cryptoController.decrypt_db_file(password)//дешифрование файла
